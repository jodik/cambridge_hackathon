...
matches_filename = ARGV[0]
matches = open(matches_filename).read

player_pages = {}

Parallel.each(matches.lines, in_threads: 5) do |line|
  columns = line.split(',')
  ...
  csv_string = CSV.generate(:col_sep => " ") do |csv|
    ...
    rows_skater.each do |row|
      ...
      source_sub = player_pages[url_sub] ||= open(url_sub).read
